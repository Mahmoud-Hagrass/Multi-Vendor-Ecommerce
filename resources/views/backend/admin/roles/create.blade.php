                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.roles.store') }}" method="POST">
                                            @csrf
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-user"></i>{{ __('dashboard.role_create') }}</h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                @foreach ($permissionsChunk as $key => $permission)
                                                                    <div class="col-md-3 col-6">
                                                                        <div class="form-check">
                                                                            <input type="checkbox" class="form-check-input" name="permissions[]" id="permission-{{ $key }}" value="{{ $key }}">
