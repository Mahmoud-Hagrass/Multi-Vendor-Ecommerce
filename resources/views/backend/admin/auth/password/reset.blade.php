                    ...
                    <form class="form-horizontal" action="{{ route('admin.password.store' , ['token' => $token]) }}" method="POST">
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                            ...
                            <div class="form-control-position">
                                <!-- No icon needed for hidden email -->
                            </div>
                        </fieldset>

                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" name="password" class="form-control form-control-lg input-lg" placeholder="{{ __('auth.new_password') }}">
                            @error('password')
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" name="password_confirmation" class="form-control form-control-lg input-lg" placeholder="{{ __('auth.new_password_confirm') }}">
