                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text" name="name"  class="form-control" placeholder="{{ __('dashboard.enter_name') }}" value="{{ $admin->name }}">
                              @error('name')
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="email" name="email" class="form-control" placeholder="{{ __('dashboard.enter_email') }}" value="{{ $admin->email }}"">
                               @error('email')
                                  <strong class="text-danger">{{ $message }}</strong>
                              @enderror
                            </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select name="status" class="form-control">
                                    ...
                                    <option value="{{ __('dashboard.active') }}" @selected($admin->status == __('dashboard.active'))>{{ __('dashboard.active') }}</option>
                                    <option value="{{ __('dashboard.in_active') }}" @selected($admin->status == __('dashboard.in_active'))>{{ __('dashboard.in_active') }}</option>
                              </select>
                               @error('status')
                                  <strong class="text-danger">{{ $message }}</strong>
                              @enderror
